...
func main() {
	...
	fmt.Println("Resultado del area [Con interfaces] ===> ", C1.getArea())
	...
	fmt.Println("Resultado del area [Con interfaces] ===> ", T1.getArea())
	fmt.Println("")
}

/* -- con implementacion de interfaces */
func (this Cuadrado) getArea() float64 {
	return this.Lado * this.Lado
}

func (this Triangulo) getArea() float64 {
